...
TRANSLATIONS = {
    ...
    "둘 다": "Both",
    "준비됨": "Ready",
    "다른 사람의 말을 녹음할 때는 미리 알리고 동의를 받아주세요. 녹음은 이 기록을 삭제할 때까지 보관되어 문장을 눌러 다시 들을 수 있습니다.": "Let people know and get consent before recording them. The recording is kept until you delete this note, so you can tap any line to hear it again.",
    "각 문장 아래에 번역을 한 줄씩 붙입니다": "Adds a translated line under each sentence",
    "번역": "Translation",
    "번역 끄기": "Translation off",
    "재생/일시정지": "Play / pause",
    "재생 위치": "Playback position",
    "문장을 누르면 그 부분부터 다시 들을 수 있습니다.": "Tap a line to hear it again from that point.",
    "Unsupported language.": "Unsupported language.",
    "Bad segment ids.": "Bad segment ids.",
    "처리 중…": "Processing…",
    ...
    '30일': '30 days',
    '–': '–',
    '강의 자료 PDF 나란히 보기 · PDF 기반 챗': 'Slides PDF side by side · chat that reads the PDF',
    '강의 자료 PDF 나란히 보기 · PDF까지 읽는 챗': 'Slides PDF side by side · chat that reads the PDF',
    '기능': 'Feature',
    '기록 보관': 'Note retention',
    '기본': 'Standard',
    '기본 노트 · 핵심 용어 · AI 챗': 'Standard notes · key terms · AI chat',
    '노트': 'Notes',
    '노트 언어': 'Notes language',
    '노트 언어 선택': "Choose the notes' language",
    '노트 언어: 강의 언어': 'Notes language: same as the lecture',
    '노트 언어를 바꿨습니다. 요약을 다시 만들면 적용됩니다.': 'Notes language changed. Regenerate the summary to apply it.',
    '노트 직접 수정': 'Edit notes by hand',
    '노트를 쓸 언어. 기본은 강의 언어입니다. 바꾼 뒤 요약을 다시 만드세요.': "Language the notes are written in. Defaults to the lecture's. Regenerate after changing.",
    '녹음 보관 · 문장 눌러 다시 듣기': 'Recordings kept · tap a line to replay',
    '녹음 보관과 문장 눌러 다시 듣기는 스튜던트 플랜부터입니다.': 'Kept recordings and tap-to-replay start with the Student plan.',
    '마크다운으로 저장됩니다. 요약을 다시 만들면 수정한 내용은 덮어써집니다.': 'Saved as markdown. Regenerating the summary overwrites your edits.',
    '무제한': 'Unlimited',
    '붙인 자료 PDF도 함께 읽습니다.': 'It also reads the attached slides.',
    '수정': 'Edit',
    '스튜던트 플랜부터': 'Student plan and up',
    '시험 요약 한 장': 'One-page exam sheet',
    '시험 요약 한 장과 빠짐없이 적는 프리미엄 노트는 스튜던트 플랜부터입니다.': 'The exam sheet and the exhaustive premium notes start with the Student plan.',
    '실시간 받아쓰기 · 링크 · 파일': 'Live transcription · links · files',
    '실시간 받아쓰기 · 링크 · 파일 업로드': 'Live transcription · links · file upload',
    '실시간 번역 (16개 언어)': 'Live translation (16 languages)',
    '실시간 번역 · 노트 언어 선택': 'Live translation · notes in any language',
    '운영자': 'owner',
    '월 받아쓰기 시간': 'Transcription hours per month',
    '자료 PDF': 'Slides PDF',
    '저장했습니다.': 'Saved.',
    '추가 크레딧 10% 할인': '10% off credit packs',
    '추가 크레딧 할인': 'Credit pack discount',
    '취소': 'Cancel',
    '폴더 · 과목 단위 질문': 'Folders · ask across a course',
    '프리미엄 (빠짐없이)': 'Premium (exhaustive)',
    '프리미엄 노트 (빠짐없이) + 시험 요약': 'Premium notes (exhaustive) + exam sheet',
    '플랜 보기': 'See plans',
